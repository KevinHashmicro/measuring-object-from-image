...
aparse.add_argument("--image", help="image path")
aparse.add_argument("--width", type=float, help="width of far left object (inches)")
...
for c in cntours:
    ...
    if pixel_to_size is None:
        ...
        distA = (dA / pixel_to_size/890) * 2.54
        distB = (dB / pixel_to_size/890) * 2.54
